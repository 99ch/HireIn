        ...
        <div style="max-width: 800px; margin: 0 auto;">
            ...
            <form action="/offres/candidater" method="post" enctype="multipart/form-data" class="form-grid">
                ...
                <div style="grid-column: 1 / -1;">
                    ...
                    <textarea 
                        ...
                        name="cover_letter" 
                        required 
                        style="width: 100%; min-height: 200px; padding: 0.75rem; border: 1px solid #ccc; border-radius: var(--radius); font-family: inherit; font-size: 0.95rem; resize: vertical;"
                        placeholder="Decrivez votre motivation pour cette offre, vos competences pertinentes, et pourquoi vous etes un bon candidat..."
                    ><?php echo isset($old['cover_letter']) ? htmlspecialchars($old['cover_letter']) : ''; ?></textarea>
                    <p style="margin: 0.5rem 0 0 0; font-size: 0.85rem; color: #666;">
                        Partagez votre passion pour ce poste et montrez pourquoi vous etes le candidat ideal.
                    </p>
                </div>
            ...
            <div style="margin-top: 3rem; padding: 1.5rem; background: #f5f5f5; border-radius: var(--radius-lg);">
                ...
                <ul style="margin: 0; padding-left: 1.5rem; font-size: 0.95rem; line-height: 1.6;">
                    ...
                    <li>Mettez en avant les competences qui correspondent a l'offre</li>
                    <li>Soyez concis mais descriptif (200-400 mots)</li>
                    <li>Joignez un CV a jour au format PDF ou Word</li>
